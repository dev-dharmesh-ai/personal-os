...
values
  ('7f0c3d2e-4a95-4eb7-9b4f-6d28a1c7e9a3', 'Finalize Q4 Strategy Deck', 'Strategy', 'Today', '14:00', 'High', 'todo', false, '90m'),
  ('7f0c3d2e-4a95-4eb7-9b4f-6d28a1c7e9a3', 'Review Engineering Specs', 'Product', 'Today', '16:30', 'Medium', 'wip', false, '45m'),
  ('7f0c3d2e-4a95-4eb7-9b4f-6d28a1c7e9a3', 'Client Sync: Project Alpha', 'Client Ops', 'Tomorrow', '11:00', 'Low', 'todo', false, '30m'),
  ('7f0c3d2e-4a95-4eb7-9b4f-6d28a1c7e9a3', 'Ship Finance Dashboard QA', 'Finance', 'Friday', '18:00', 'High', 'wip', false, '2h'),
  ('7f0c3d2e-4a95-4eb7-9b4f-6d28a1c7e9a3', 'Archive Sprint Notes', 'Operations', 'Yesterday', '19:00', 'Low', 'done', true, '20m');

insert into public.transactions
  (user_id, date, name, note, category, amount, type)
values
  ('7f0c3d2e-4a95-4eb7-9b4f-6d28a1c7e9a3', '2026-05-28', 'Salary Credit', 'Monthly income', 'income', 125000, 'income'),
  ('7f0c3d2e-4a95-4eb7-9b4f-6d28a1c7e9a3', '2026-05-27', 'Cloud Infrastructure', 'Hosting and AI services', 'infra', 18400, 'expense'),
  ('7f0c3d2e-4a95-4eb7-9b4f-6d28a1c7e9a3', '2026-05-26', 'Team Dinner', 'Sprint closeout', 'food', 4250, 'expense'),
  ('7f0c3d2e-4a95-4eb7-9b4f-6d28a1c7e9a3', '2026-05-25', 'Airport Transfer', 'Client travel', 'travel', 1800, 'expense'),
  ('7f0c3d2e-4a95-4eb7-9b4f-6d28a1c7e9a3', '2026-05-24', 'Advisory Retainer', 'Consulting income', 'income', 32000, 'income');
